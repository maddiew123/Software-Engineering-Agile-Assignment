...
export default function MatchInput({ num, index, inlocation, indate, inopponent, inhome, handleUpdate }: { num?: number, index?: number, inlocation: string; indate: Dayjs | null; inopponent: number; inhome: number, handleUpdate?: (index: number, updatedMatch?: any) => void; }) {
